//exercise 1.3 create the BankReport class with the specific methods
...
public class BankReport {
    ...
    public Map<String, ArrayList<Client>> getClientsByCity() {
        //exercise 1.4 stores instances of the Client class and maintains them in alphabetical order
        Set sortedClients = bank.getClients();
        //exercise 1.4 associates each city with a list of clients residing in that city
